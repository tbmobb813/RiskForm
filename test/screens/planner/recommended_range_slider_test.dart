...
void main() {
  testWidgets('RecommendedRangeSlider shows recommended range from provider', (
    tester,
  ) async {
    final ranges = <String, RangeValues>{
      'delta': const RangeValues(0.15, 0.20),
    };
    final bundle = planner_hints.PlannerHintBundle(
      hints: const [],
