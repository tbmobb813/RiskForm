...
void main() {
  test(
    'signInWithEmail maps user-not-found to AuthenticationException',
    () async {
      ...
      expect(
        ...
        throwsA(
          predicate(
            (e) => e is Exception && e.toString().contains('No account found'),
          ),
        ),
      );
    },
  ...
  test(
    'signUpWithEmail maps email-already-in-use to AuthenticationException',
    () async {
      final mock = MockFirebaseAuth();
      when(
        ...
        FirebaseAuthException(code: 'email-already-in-use', message: 'exists'),
      );
      ...
      expect(
        ...
        throwsA(
          predicate(
            (e) =>
                e is Exception &&
                e.toString().contains('An account already exists'),
          ),
        ),
      );
    },
