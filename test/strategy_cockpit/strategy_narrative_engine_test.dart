...
void main() {
  test(
    'generateNarrative produces a summary and bullets for basic context',
    () {
      ...
      final recBundle = StrategyRecommendationsBundle(
        ...
        recommendations: [
          StrategyRecommendation(
            category: 'parameter',
            message: 'Tighten delta to 0.15–0.20',
            priority: 2,
          ),
        ],
      );
      ...
      expect(
        narrativeWithRec.summary.toLowerCase().contains('sideways'),
        isTrue,
      );
      ...
      final joined =
          '${narrativeWithRec.bullets.join(' ')} ${narrativeWithRec.outlook}';
