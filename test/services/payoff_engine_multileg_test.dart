...
void main() {
  group('PayoffEngine multi-leg', () {
    ...
    test('Long call + short call (call spread) payoff at points', () {
      ...
      expect(
        engine.payoffForContractsWithQuantities(
          contracts: contracts,
          quantities: quantities,
          underlyingPrice: 45.0,
        ),
        -1.0 * PayoffEngine.contractSize,
      );
    ...
    test('Short put + shares (synthetic covered put) at price', () {
      ...
      final shareLeg = Leg.shares(
        id: 'SHARES',
        shares: 100,
        costBasisPerShare: 55.0,
      );
