...
void main() {
  group('PayoffEngine payoffAtPrice', () {
    ...
    test('csp payoff at prices', () {
      ...
      final below = engine.payoffAtPrice(
        strategyId: 'csp',
        inputs: inputs,
      ...
      final above = engine.payoffAtPrice(
        strategyId: 'csp',
        inputs: inputs,
  ...
  group('PayoffEngine generatePayoffCurve', () {
    ...
    test('curve length and monotonic price axis', () {
      ...
      final startPay = engine.payoffAtPrice(
        strategyId: 'long_call',
        inputs: inputs,
        underlyingPrice: 80.0,
      );
      final endPay = engine.payoffAtPrice(
        strategyId: 'long_call',
        inputs: inputs,
