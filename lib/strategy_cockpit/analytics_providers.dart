...
final strategyRecommendationsEngineProvider =
    Provider<StrategyRecommendationsEngine>((ref) {
      return const StrategyRecommendationsEngine();
    });

final strategyNarrativeEngineProvider = Provider<StrategyNarrativeEngine>((
  ref,
) {
