...
class LongCallStrategy extends TradingStrategy {
  ...
  StrategyExplanation explain() {
    return StrategyExplanation(
      summary: 'A bullish strategy with defined risk and unlimited upside.',
      pros: ['Defined risk', 'Unlimited upside', 'Cheap exposure'],
      cons: ['Time decay', 'Volatility sensitivity'],
      idealConditions: ['Bullish trend', 'Low IV environment'],
